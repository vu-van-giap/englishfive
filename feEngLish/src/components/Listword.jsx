                ...
                <div key={index} className={styles.container_word}>
                    <div className={styles.new_word}>
                        ...
                        <div className={styles.action_word}>
                            ...
                            <button onClick={() => handleDelete(word?._id)} className={styles.delete}><svg className="w-[24px] h-[24px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
