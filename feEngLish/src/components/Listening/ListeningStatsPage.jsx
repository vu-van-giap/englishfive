...
const ListeningStatsPage = () => {
    ...
    const statsData = [
        ...
        },
        {
            ...
            trend: stats?.averageScore > 70 ? { up: true, value: 5 } : { up: false, value: 3 }
        },
        {
            title: "Điểm cao nhất",
            value: "100/100",
                ...
                <div className="p-4">
                    {history.length > 0 ? (
                            ...
                            {history.map((item, index) => (
                                <div key={index} className="flex items-center p-3 hover:bg-gray-50 rounded-lg transition">
                                    ...
                                    <div className="flex-1">
                                        <p className="font-medium text-gray-900">Hoàn thành bài tập</p>
                        ...
                        <div className="text-center py-8">
                            ...
                            <h3 className="mt-2 text-sm font-medium text-gray-900">Chưa có lịch sử làm bài</h3>
                            <p className="mt-1 text-sm text-gray-500">Hãy bắt đầu làm bài tập để xem thống kê.</p>
                        </div>
                    )}
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-start p-3 bg-white rounded-lg border">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Đặt mục tiêu làm ít nhất 5 bài tập mỗi tuần</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start p-3 bg-white rounded-lg border">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600">Thử các bài tập về chủ đề mới như Kinh doanh hoặc Khoa học</p>
                        </div>
                    </div>
                </div>
            </div>
